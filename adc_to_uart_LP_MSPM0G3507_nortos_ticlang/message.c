...
static struct message read_power_system_status = {
...
static struct message read_power_rail_temp_req = {
...
static struct message read_power_rail_temp_cfm = {
...
static struct message read_power_rail_voltage_rej = {
...
static struct message set_power_rail_voltage_req = {
...
static struct message set_power_rail_voltage_ext_a_req = {
...
static struct message set_power_rail_voltage_ext_b_req = {
...
struct message *MSG_SetVoltageExtA(uint8_t rail_id, uint8_t voltage_setpoint_byte0) {
    // Define a temporary message
    struct message *msg = &set_power_rail_voltage_ext_a_req;
